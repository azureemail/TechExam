...
//        [HttpPost("getProductAnonymous")]
//        [AllowAnonymous]
//        public async Task<IActionResult> getProductAnonymous([FromBody] PageSizeAndNumber pageSizeAndNumber)
//        {
//            try
//            {
//                var result = await _product.GetProductsAnonymous(pageSizeAndNumber);
...
//        [HttpPost("getProductAuthorized")]
//        [Authorize]
//        public async Task<IActionResult> getProductAuthorized([FromBody] PageSizeAndNumber pageSizeAndNumber)
//        {
//            try
//            {
//                var result = await _product.GetProductsAuthorized(pageSizeAndNumber);
...
//        [HttpPost("getProductLocalDB")]
//        [AllowAnonymous]
//        public async Task<IActionResult> getProductLocalDB([FromBody] PageSizeAndNumber pageSizeAndNumber)
//        {
//            try
//            {
//                var result = await _product.GetProductLocalDB(pageSizeAndNumber);
